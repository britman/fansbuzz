...
namespace NewsPoster
{
    class FeedItems : List<FeedItem>
    {
        public FeedItems()
        {
            ...
            this.Add(new FeedItem(new Uri("http://feeds.teletext.co.uk/sport/football/stories")));
            this.Add(new FeedItem(new Uri("http://feeds.teletext.co.uk/sport/football/scores/")));            
        }
    }
}
